...
// TripRepository bean will be created only when "develop" profile is activated, useful for development purposes
@Profile("develop")
@Repository
    ...
    public List<Trip> findAll() {
        return List.of(
                Trip.builder()
                        ...
                        .destination(new Destination( 3L,"UK", "London", "Hilton"))
                        ...
                        .hotelFacilities(new HotelFacilities(5L,List.of(), List.of("bathroom", "bed")))
                        .photos(List.of("https://fastly.4sqi.net/img/general/600x600/1376806605_Hc3gxR3iMMI5OKRpt7ook-zGGreT4XxgEapWx0wC844.jpg"))
                        .build(),
                Trip.builder()
                        .tripStartDate(LocalDate.now().plusDays(1))
                        .tripEndDate(LocalDate.now().plusDays(15))
                        .destination(new Destination(4L,"Thailand", "Bangkok", "Sawasdee Sunshine"))
                        .tripPrice(new Price(BigDecimal.valueOf(1_500L), "baht"))
                        .typeOfTransport(TransportType.PLANE)
                        .securityRules(new SecurityRules(2L, "", ""))
                        .paymentType(PaymentType.CARD)
                        .mealType(MealType.ALL_INCLUSIVE)
                        .hotelFacilities(new HotelFacilities(6L,List.of(), List.of("Bed", "Swiming Pool", "Bathroom", "Parking")))
